...
import { editKBPatient } from '@/app/lib/actions';
...
export default function EditKBForm(patientData: any) {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      await editKBPatient(data, id_pasien);
      toast({
        title: `Berhasil Menginputkan Update Pasien: ${data.generalInformation.namaPeserta}`,
      });
    } catch {
      toast({
